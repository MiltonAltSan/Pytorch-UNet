...
class Recurrent_block(nn.Module):
    ...
    """
    def __init__(self, n_classes, t=2):
...
class RRCNN_block(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, t=2):
        ...
        self.RCNN = nn.Sequential(
            Recurrent_block(n_classes, t=t),
            Recurrent_block(n_classes, t=t)
        )
        self.Conv = nn.Conv2d(n_channels, n_classes, kernel_size=1, stride=1, padding=0)
...
#     Args:
#         n_channelsannels = Input Channels
#         n_classesannels = Output Channels
#         kernal_size = 3
#         activation = Relu
#         batchnorm = True
# 
...
# 
#     def __init__(self, n_channelsannels, n_classesannels, kernal_size=3, activation='Relu', batchnorm=True):
#         super(Convolution2, self).__init__()
# 
#         self.n_channelsannels = n_channelsannels
#         self.n_classesannels = n_classesannels
...
# 
#         self.conv1 = nn.Conv2d(self.n_channelsannels, self.n_classesannels, self.kernal_size,  padding=1, bias=True)
#         self.conv2 = nn.Conv2d(self.n_classesannels, self.n_classesannels, self.kernal_size, padding=1, bias=True)
# 
#         self.b1 = nn.BatchNorm2d(n_classesannels)
#         self.b2 = nn.BatchNorm2d(n_classesannels)
# 
...
#         n5 = n4*2
# 
#         self.dconv_down1 = Convolution2(n_channels, n1)
